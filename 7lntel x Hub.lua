...
local Window = Library.CreateLib("7lntel x Hub", "LightTheme")

local Tab = Window:NewTab("เมนูหลัก")
local Section = Tab:NewSection("Thai soldiers")

Section:NewButton("jerk off r6/r15", "สคิปชักว่าว", function()

loadstring(game:HttpGet("https://pastefy.app/wa3v2Vgm/raw"))() 
--This one is r15:
loadstring(game:HttpGet("https://pastefy.app/YZoglOyJ/raw"))()
end)
Section:NewButton("fly", "บิน", function()
...
Section:NewButton("admin", "แอดมิน", function()
local game = game
 ...
 Notify({
		 Description = "https://discord.gg/NCB78D5Pwe";
		 Title = "7lntel x Hub ขอบคุณลูกค้าที่ใช้สคิปจำนวน7ล้านท่านนะครับขอให้สนุกกับสคิปนะครับ";
		 Duration = 20;
...
Section:NewButton("ล่องหน", "ล่องหน", function()
loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-Invisible-script-20557"))()
end)
Section:NewButton("เสกปืน", "เสกปืน", function()
local ScreenGui = Instance.new("ScreenGui")
local Frame = Instance.new("Frame")
...
Section:NewButton("ล็อกหัว", "ล๊อกหัว", function()
getgenv().khen = {
    ['Silent'] = {
        Normal = {
            Enabled = true,
...
Section:NewButton("เปลี่ยนทีม", "เปลี่ยนทีม", function()
loadstring(game:HttpGet("https://pastebin.com/raw/i0tGNGRY"))()
end)
Section:NewButton("ดึงคน", "ดึงคน", function()
loadstring(game:HttpGet("https://pastebin.com/raw/CuDBzSm6"))()
end)
Section:NewButton("ทะลุกำแพง", "ทะลุกำแพง", function()
loadstring(game:HttpGet("https://pastebin.com/raw/7Qab6kg9"))()
end)

local Tab = Window:NewTab("ระบบต่างๆๆ")
local Section = Tab:NewSection("เมนูหลัก")
Section:NewButton("ESP", "ESP", function()
loadstring(game:HttpGet("https://pastebin.com/raw/ZkLhNuDL",true))()
end)
Section:NewButton("DEX", "DEX", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/infyiff/backup/main/dex.lua"))()
end)

local Tab = Window:NewTab("ไททัน")
local Section = Tab:NewSection("House")
Section:NewButton("ไททัน", "ไททัน", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/zerunquist/TekkitAotr/refs/heads/main/main"))()
end)

local Tab = Window:NewTab("Dead rail")
local Section = Tab:NewSection("เมนูหลัก")
Section:NewButton("Dead rail", "Dead rail", function()
loadstring(game:HttpGet('https://pastebin.com/raw/rKSis1yk'))()
end) 
--    loadstring(game:HttpGet("https://pastebin.com/raw/jvS0ekUS",true))()     --7lntel x Hub